...
from .utility import EResidualBlock, BasicBlock, UpsampleBlock, MeanShift
...
class CARN_M(nn.Module):
    def __init__(self, in_nc, out_nc, nf, scale=4, group=4):
        ...
        self.name = f'CARN_B6_F{nf}_S{scale}'
